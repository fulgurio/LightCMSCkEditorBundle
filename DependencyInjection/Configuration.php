<?php
/*
 * This file is part of the LightCMSCkEditorBundle package.
 *
...
namespace Fulgurio\LightCMSCkEditorBundle\DependencyInjection;
...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->addDefaultsIfNotSet()
            ->children()
                ->scalarNode('admin_footer')->defaultValue('FulgurioLightCMSCkEditorBundle::bottom.html.twig')->end()
            ->end()
            ->children()
                ->scalarNode('admin_top_media')->defaultValue('FulgurioLightCMSCkEditorBundle::popupTop.html.twig')->end()
            ->end()
            ->children()
                ->scalarNode('admin_bottom_media')->defaultValue('FulgurioLightCMSCkEditorBundle::popupBottom.html.twig')->end()
            ->end()
            ->children()
            ->arrayNode('config')
                ->addDefaultsIfNotSet()
